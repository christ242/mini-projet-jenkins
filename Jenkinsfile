...
pipeline {
    environment {
        ...
        APP_NAME = "kitepoye"
        STG_API_ENDPOINT = "192.168.56.8:1993"
        STG_APP_ENDPOINT = "192.168.56.8:${PORT_EXPOSED}90"
        PROD_API_ENDPOINT = "192.168.56.8:1993"
        PROD_APP_ENDPOINT = "192.168.56.8:${PORT_EXPOSED}"
        INTERNAL_PORT = "80"
